...
--к заданию 2 по образцу написанного sql кода для города/страны рождения, 
--можно было бы прикрутить фичи по городу/страны смерти,
--а также городу/страны организации-университета.
